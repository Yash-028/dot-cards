...
const ProductDetail = () => {
  ...
  const currentImage =
    shoedata[2].imgdesk && shoedata[2].imgdesk[currentImageIndex];
    ...
    <Product>
      <ProductInfo>
        ...
        <RightBox>
          <ProductTitle>
            <ShoeTag>
              <span className={StyleSheet.h6}>{shoedata[2].name}</span>
              <span className={StyleSheet.h7}>{shoedata[2].desc}</span>
            </ShoeTag>
            <span className={StyleSheet.h8}>${shoedata[2].price}</span>
          </ProductTitle>
          <ProductQuantity>
